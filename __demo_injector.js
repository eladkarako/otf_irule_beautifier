...
var iframe_window = window;//document.getElementById("contentframe").contentWindow;
var iframe_document = document;//iframe_window.document;
...
iframe_window.toolkit.useCache = true;
        ...
        setTimeout(function () {
            ...
            setTimeout(function () {
                ...
                var editor = CodeMirror(function(elt) {
                  oText.parentNode.replaceChild(elt, oText);
                }, {value: oText.value});
/*
